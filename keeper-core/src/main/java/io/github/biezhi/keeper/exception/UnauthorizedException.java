...
import static io.github.biezhi.keeper.keeperConst.ERROR_MESSAGE_NOT_PERMISSION;
 ...
 */
@NoArgsConstructor
public class UnauthorizedException extends KeeperException {
    ...
    public static UnauthorizedException build() {
        return build(ERROR_MESSAGE_NOT_PERMISSION);
    }
